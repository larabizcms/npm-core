...
import { registerUser, loginUser, refreshToken, forgotPassword, resetPassword, resendEmailVerification } from './authActions';
...
const authSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        builder.addCase(registerUser.pending, (state, action) => {
            ...
            builder.addCase(resendEmailVerification.pending, (state, action) => {
                state.loading = true;
                state.payload = null;
            }),
            builder.addCase(resendEmailVerification.fulfilled, (state, { payload }) => {
                state.loading = false;
                state.success = true;
            }),
            builder.addCase(resendEmailVerification.rejected, (state, action) => {
                state.loading = false;
                state.payload = action.payload;
            })
    },
